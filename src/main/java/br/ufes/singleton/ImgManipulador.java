...
import javax.swing.ImageIcon;
    ...
    //Código baseado em alguns métodos encontrados em: youtube.com/watch?v=lCc2ol0GQyc
public class ImgManipulador {

    private static ImgManipulador instancia = null;
    
    private ImgManipulador() {
    }

    public static ImgManipulador getInstancia() {
        if(instancia == null){
            instancia = new ImgManipulador();
        }
    ...
    public BufferedImage setImagemDimensao(String caminhoImg, Integer imgLargura, Integer imgAltura) {
        ...
        try {
            ...
            Logger.getLogger(instancia.getClass().getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public byte[] getImgBytes(BufferedImage image) {
        ...
        try {
            ...
            throw new RuntimeException("Erro ao exibir a imagem!");
        }
